...
# === Config ===
PARQUET_PATH = "./data/geographic_data/terrain_embeddings.parquet"
OUTPUT_PATH = "./experiments/embedding_space/terrain_embedding_space.png"
MAX_POINTS = 80000
POINT_SIZE = 20
ALPHA = 0.5
COLORMAP = "plasma"
...
ax.set_title("Terrain Embedding Similarity (1D PCA)")
ax.set_aspect("equal")
